...
module.exports = (environmentDef) => new Promise(async (resolve, reject) => {
    ...
    try {
        ...
        const responseObj = await requestInstance.post(thisRequestDef.url, 'grant_type=urn:demandware:params:oauth:grant-type:client-id:dwsid:dwsecuretoken', thisRequestDef);
