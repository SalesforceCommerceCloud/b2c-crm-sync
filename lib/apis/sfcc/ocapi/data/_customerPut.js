 ...
 */
module.exports = (requestInstance, accessToken, customerListId, customerNo, profileUpdate) => new Promise(async (resolve, reject) => {
    ...
    try {
        ...
        const responseObj = await requestInstance.put(thisRequestDef.url, thisRequestDef.body, thisRequestDef);
