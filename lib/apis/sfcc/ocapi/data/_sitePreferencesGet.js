 ...
 */
module.exports = (requestInstance, accessToken, siteId, preferenceGroup) => new Promise(async (resolve, reject) => {
    ...
    try {
        ...
        const thisRequestDef = requestLib.createOCAPIDataRequestDef(
                ocapiUrlSuffix,
                accessToken
            ),

            // Execute and process the request; wait for the results
            responseObj = await requestInstance.get(thisRequestDef.url, thisRequestDef);
