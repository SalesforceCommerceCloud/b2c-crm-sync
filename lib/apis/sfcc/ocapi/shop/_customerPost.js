 ...
 */
module.exports = (envDef, siteId, clientId, guestAuthToken, customerProfile) => new Promise(async (resolve, reject) => {
    ...
    try {
        ...
        let thisRequestDef = requestLib.createOCAPIShopRequestDef(ocapiUrlSuffix, siteId, clientId, guestAuthToken);
        ...
        if (responseObj.headers.hasOwnProperty('authorization')) {
