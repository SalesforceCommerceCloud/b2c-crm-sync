...
module.exports = (environmentDef) => {
    ...
    const audienceUrl = `${amProperties.baseUrl}:443${amProperties.authUrl}`;
    ...
    output.jwt.requestBody = `grant_type=client_credentials&client_assertion_type=urn%3Aietf%3Aparams%3Aoauth%3Aclient-assertion-type%3Ajwt-bearer&client_assertion=${output.jwt.token}`;
