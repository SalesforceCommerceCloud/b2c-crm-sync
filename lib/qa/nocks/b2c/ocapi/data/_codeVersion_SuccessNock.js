...
/**
 * @function _codeVersion_SuccessNock
 ...
 */
function _codeVersion_SuccessNock(environmentDef, httpMethod) {
    ...
    baseNock = {
        ...
        rollback: false,
        web_dav_url: `https://${environmentDef.b2cHostName}/on/demandware.servlet/webdav/Sites/Cartridges/${environmentDef.b2cCodeVersion}`
    };
...
module.exports = _codeVersion_SuccessNock;
