...
module.exports = commandProgram => {
    ...
    commandProgram
        ...
        .description('Toggles the active code-version for the specified B2C Commerce environment -- defaults to the .env; can be overridden via the CLI\')')
        .action(async commandObj => {
            ...
            try {
                if (!isJSONOperationMode) {
                    ...
                    console.log(` -- Attempting to toggle the B2C code-version '${environmentDef.b2cCodeVersion}' using the following environment details`);
                ...
                cliUi.outputResults(resultObj.outputDisplay.codeVersions, undefined, 'cliTableConfig.codeVersionOutput');
                ...
                if (resultObj.noToggle === true) {
                    ...
                    cliUi.outputResults([resultObj.outputDisplay.toggleCodeVersion], undefined, 'cliTableConfig.codeVersionOutput');
                    ...
                    cliUi.outputResults(resultObj.outputDisplay.codeVersionsToggle, undefined, 'cliTableConfig.codeVersionOutput');
                    ...
                    cliUi.outputResults([resultObj.outputDisplay.activeCodeVersion], undefined, 'cliTableConfig.codeVersionOutput');
                    ...
                    cliUi.outputResults(resultObj.outputDisplay.codeVersionsActivate, undefined, 'cliTableConfig.codeVersionOutput');
