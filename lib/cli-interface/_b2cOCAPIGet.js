...
module.exports = commandProgram => {
    ...
    commandProgram
        ...
        .description('Attempts to retrieve the OCAPI configuration for the B2C Instance using BM User Credentials -- defaults to the .env; can be overridden via the CLI')
        .action(async commandObj => {
            ...
            try {
                ...
                console.log(' -- Attempting to authenticate against the configured B2C instance via Business Manager credentials');
                ...
                if (resultObj.success === false) { return commandProgram; }
                ...
                ocapiConfigResults = await cliAPI.b2cOCAPIGet(environmentDef, resultObj.authToken);
                ...
                if (ocapiConfigResults.ocapiConfig.success === true) {
                    ...
                    cliUi.outputResults(ocapiConfigResults.outputDisplay.global, undefined, 'cliTableConfig.ocapiConfig');
                    ...
                    if (ocapiConfigResults.outputDisplay.sites.length > 0) {
                        ...
                        cliUi.outputResults(ocapiConfigResults.outputDisplay.sites, undefined, 'cliTableConfig.ocapiConfig');
                    ...
                    cliUi.outputResults(ocapiConfigResults.outputDisplay.global, undefined, 'cliTableConfig.genericFault');
