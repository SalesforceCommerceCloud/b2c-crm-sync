...
module.exports = commandProgram => {
    ...
    commandProgram
        ...
        .description('Attempts to authenticate against the specified B2C Commerce environment using BM User Credentials -- defaults to the .env; can be overridden via the CLI')
        .action(async commandObj => {
            ...
            try {
                ...
                if (ocapiConfigResults.ocapiConfig.success === true) {
                    ...
                    cliUi.outputResults(ocapiConfigResults.outputDisplay, undefined, 'cliTableConfig.genericFault');
