    ...
    commandProgram
        ...
        .action(async commandObj => {
            ...
            try {
                ...
                // 9. Create the OOBO customer for each site
                ...
                if (isJSONOperationMode) {
                    ...
                    console.log(' -- Creating the Assisted Shopping / Order-on-Behalf-Of storefront customer profiles');

                }

                // Retrieve and output the results of the verification process
                resultObj = await cliAPI.verifyB2CSites(commandOptions);
                output.siteVerificationResults = resultObj;

                // Collect the customerResults from the OOBO customer deployment
                ...
                if (isJSONOperationMode) {
                    output.ooboCustomerResults = customerResults;
                } else {
                ...
                if (isJSONOperationMode) {
                    ...
                    // Output the notification alerting that we're creating / verifying the OOBO customer
