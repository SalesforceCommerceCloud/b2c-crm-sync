...
module.exports = commandProgram => {
    ...
    commandProgram
        ...
        .description('Generates the meta-data, deploy the meta-data to the B2C Commerce instance -- ' +
        ...
        .action(async commandObj => {
            ...
            try {
                ...
                cliUi.cliCommandBookend(
                    commandObj._name,
                    'start',
                    'Attempting to deploy the B2C meta-data zip file generated by "crm-sync:b2c:data:zip"',
                    environmentDef);
                ...
                const resultObj = await cliAPI.b2cDeployData(
                    environmentDef,
                ...
                cliUi.outputResults(
                    [resultObj.outputDisplay.import],
                    undefined,
