...
module.exports = commandProgram => {
    ...
    commandProgram
        ...
        .description('Activates the configured code-version for the specified B2C Commerce environment -- defaults to the .env; can be overridden via the CLI')
        .action(async commandObj => {
            ...
            try {
                if (!isJSONOperationMode) {
                    ...
                    console.log(` -- Attempting to activate the B2C code-version '${environmentDef.b2cCodeVersion}' using the following environment details`);
