...
module.exports = commandProgram => {
    ...
    commandProgram
        ...
        .description('Create a scratch-org, build dxTemplates, and deploy crm-sync code to the scratchOrg via the CLI -- defaults to the .env')
        .action(async commandObj => {
            ...
            try {
                ...
                await commonFs.verifyAndCreateFolder(`${config.get('paths.source.dx.base')}${config.get('paths.source.dx.deployPath')}namedCredentials`);
