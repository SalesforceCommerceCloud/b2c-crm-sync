...
module.exports = commandProgram => {
    ...
    commandProgram
        ...
        .description('Generate the SFDX B2C OOBO / BM UserGrant NamedCredentials deployment metadata -- defaults to the .env; can be overridden via the CLI')
        .action(async commandObj => {
            ...
            try {
                ...
                // Initialize and open the bookend
                cliUi.cliCommandBookend(commandObj._name, 'start');
                console.log(' -- Attempting to generate the "Order On Behalf" Named Credentials file using the following environment details');
