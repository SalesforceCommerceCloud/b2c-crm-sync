...
/**
 * @function _b2cCodeDeployReset
 * @description This function is used to reset the contents of the B2C Commerce code deployment folder.
...
module.exports = commandProgram => {
    ...
    commandProgram
        .command('crm-sync:b2c:code:deploy:reset')
        ...
        .description('Resets the contents of the B2C Commerce code deployment-folder; purges the entire directory')
        .action(async commandObj => {
            ...
            try {
                if (!isJSONOperationMode) {
                    ...
                    console.log(' -- Attempting to reset the B2C code deployment folders');
                }

                // Retrieve and output the results of the reset activity
                const resultObj = await cliAPI.b2cDeployReset(config.get('paths.b2cLabel'), config.get('paths.cartridgePathLabel'));
