...
module.exports = commandProgram => {
    ...
    commandProgram
        ...
        .description('Verifies that the code-version specified is valid and exists within the specified ' +
        ...
        .action(async commandObj => {
            ...
            try {
                ...
                cliUi.cliCommandBookend(
                    commandObj._name,
                    'start',
                    'Attempting to verify the B2C code-version [${environmentDef.b2cCodeVersion}]',
                    environmentDef);
