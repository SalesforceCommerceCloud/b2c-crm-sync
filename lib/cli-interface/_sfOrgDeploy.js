    ...
    commandProgram
        ...
        .action(async commandObj => {
            ...
            try {
                ...
                // Skip status if we're in a production-org
                if (environmentDef.sfLoginUrl !== 'login.salesforce.com') {
                    ...
                    console.log(' -- retrieving the Salesforce org status after the deployment; please standby');
                    resultObj = await cliAPI.sfOrgStatus(environmentDef);

                    // Only display the status if one was retrieved
