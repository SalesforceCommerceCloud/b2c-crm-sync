    ...
    commandProgram
        ...
        .action(async commandObj => {
            ...
            try {
                ...
                // Render the siteTemplate results for other template-driven elements
                resultObj.outputDisplay.siteIds.filter(
                    site => Object.prototype.hasOwnProperty.call(resultObj.outputDisplay.siteTemplateResults, site))
                ...
                // Define the status properties used to render the deployment status
                localCommandOpts.statusLocal = false;
                localCommandOpts.statusRemote = true;

                // Retrieve the salesforce org's deployment status
                resultObj = await cliAPI.sfOrgStatus(localCommandOpts);

                // Output the orgStatus for the current org
                cliUi.outputResults(resultObj.outputDisplay, undefined, 'cliTableConfig.scratchOrgDeployResults');
