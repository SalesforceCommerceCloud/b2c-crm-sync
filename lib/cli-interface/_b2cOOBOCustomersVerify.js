...
module.exports = commandProgram => {
    ...
    commandProgram
        ...
        .description('Retrieve the OOBO user details for each configured storefront -- defaults to the storefronts defined in the .env; can be overridden via the CLI')
            ...
            try {
                ...
                if (resultObj.outputDisplay.verifySites.success.length > 0) {
                    ...
                    if (customerVerifyResults.length === 0) {
                        ...
                        console.log(' -- Retrieving the OOBO Anonymous Customer customerId values from sitePreferences for these sites');
                        sitePreferenceResults = await cliAPI.b2cOOBOSitePrefsGet(environmentDef, resultObj.outputDisplay.authenticate.authToken, resultObj.siteResults.success);
