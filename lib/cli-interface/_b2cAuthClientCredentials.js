...
module.exports = commandProgram => {
    ...
    commandProgram
        ...
        .description('Attempts to authenticate against the specified B2C Commerce environment -- defaults to the .env; can be overridden via the CLI')
        .action(async commandObj => {
            ...
            try {
                ...
                console.log(' -- Attempting to authenticate against the configured B2C instance using the following environment details');
