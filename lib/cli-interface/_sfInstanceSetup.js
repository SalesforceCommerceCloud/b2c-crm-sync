    ...
    commandProgram
        ...
        .action(async commandObj => {
            ...
            try {
                ...
                console.log(' -- Attempting to authenticate against the configured Salesforce Core Platform ' +
                ...
                resultObj = await cliAPI.sfB2CInstanceSetup(
                    environmentDef, output.sfAuthResults.apiCalls.sfAuthenticate.authResults);
