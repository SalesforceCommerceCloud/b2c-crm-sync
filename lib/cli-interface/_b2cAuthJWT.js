        ...
        .action(async commandObj => {
            ...
            try {
                ...
                if (resultObj.success === true) {
                    ...
                    cliUi.outputResults(resultObj.outputDisplay, undefined, 'cliTableConfig.b2cJWTOutput');

                } else {

                    // Output the success results via the console
                    cliUi.outputResults(resultObj.outputDisplay, undefined, 'cliTableConfig.b2cJWTOutput');
                    cliUi.outputResults(resultObj.errorOutputDisplay, undefined, 'cliTableConfig.genericFault');
