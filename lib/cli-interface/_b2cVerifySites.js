...
module.exports = commandProgram => {
    ...
    commandProgram
        ...
        .description('Verifies that the siteIds specified are valid and exist in the specified B2C Commerce' +
        ...
        .action(async commandObj => {
            ...
            try {
                ...
                cliUi.cliCommandBookend(
                    commandObj._name,
                    'start',
                    'Attempting to verify the B2C sites on the target instance',
                    environmentDef);
