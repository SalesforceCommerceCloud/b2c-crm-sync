...
module.exports = commandOptions => {
    ...
    if (process.env.hasOwnProperty('B2C_INSTANCENAME')) { output.b2cInstanceName = process.env.B2C_INSTANCENAME; }
    ...
    if ((output.b2cInstanceName === undefined || output.b2cInstanceName.trim().length === 0) && output.hasOwnProperty('b2cHostName') && output.b2cHostName !== undefined) {
        ...
        if (output.b2cInstanceName.indexOf('-') > -1) { output.b2cInstanceName = output.b2cInstanceName.split('-')[0]; }
