...
module.exports = async (environmentDef, sfAuth) => {
    ...
    if (output.data.outputValues.success === true) {
        ...
        output.customerLists = output.data.outputValues.createdB2CCustomerLists.concat(output.data.outputValues.updatedB2CCustomerLists);
        ...
        let createdB2CSites = output.data.outputValues.createdB2CSites.map(thisObj => thisObj.Name);
        let updatedB2CCustomerLists = output.data.outputValues.updatedB2CCustomerLists.map(thisObj => thisObj.CustomerList_ID__c);
        let updatedB2CSites = output.data.outputValues.updatedB2CSites.map(thisObj => thisObj.Name);
        ...
        output.outputDisplay = [
            ['b2cInstance', environmentDef.b2cInstanceName],
            ['success', output.data.outputValues.success],
            ['error message', output.data.outputValues.errorMessage]
        ];
