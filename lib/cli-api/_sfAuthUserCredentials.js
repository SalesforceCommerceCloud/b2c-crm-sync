...
module.exports = environmentDef => new Promise(async (resolve, reject) => {
    ...
    try {
        ...
        output.apiCalls.sfAuthenticate.authResults = await sfAuthenticate(environmentDef.sfLoginUrl, environmentDef.sfUsername, environmentDef.sfPassword, environmentDef.sfSecurityToken);
