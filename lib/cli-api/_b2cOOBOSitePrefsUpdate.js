 ...
 * @returns {Promise}
 */
module.exports = (environmentDef, b2cAdminAuthToken, verifiedSites, customerProfiles) => new Promise(async (resolve, reject) => {
        ...
        for (let thisSite of verifiedSites) {
            ...
            if (preferenceUpdateResults.success === true) {
                ...
                output.outputDisplay.push([
                    ...
                    ['success', true],
                    ['AgentHeaderIsEnabled', preferenceUpdateResults.data.c_b2ccrm_syncAgentHeaderIsEnabled],
