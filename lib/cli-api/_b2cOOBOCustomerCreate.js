...
module.exports = (environmentDef, siteDef) => new Promise(async (resolve, reject) => {
    ...
    if (output.apiCalls.customerGet.data.hasOwnProperty('c_b2ccrm_accountId') || output.apiCalls.customerGet.data.c_b2ccrm_accountId === undefined) {
        output.apiCalls.customerGet.data.c_b2ccrm_accountId = '---';
    }
