...
describe('List B2C Commerce Code Versions via the CLI', function () {
    ...
    cliCommand = parseCLICommand('npm run crm-sync:b2c:cv:list -- -om json');

    it('should provide a JSON string representing the retrieved code versions', async function () {
    ...
    it('returns the collection of code-versions with their expected attributes', async function () {
