...
describe('Activating a B2C Commerce Code Version via the CLI', function () {
    ...
    it('should provide a JSON string representing the activated code version', async function () {
    ...
    it('returns the properties describing the activated code-version', async function () {
