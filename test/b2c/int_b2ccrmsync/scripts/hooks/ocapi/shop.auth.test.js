...
describe('int_b2ccrmsync/cartridge/scripts/b2ccrmsync/hooks/ocapi/shop.auth', function () {
    let sandbox;
    let spy;
    let requireStub;
    let customer;
    ...
    beforeEach(function () {
        ...
        shopAuthHook = proxyquire(path.join(process.cwd(), 'src/sfcc/cartridges/int_b2ccrmsync/cartridge/scripts/b2ccrmsync/hooks/ocapi/shop.auth'), requireStub);
