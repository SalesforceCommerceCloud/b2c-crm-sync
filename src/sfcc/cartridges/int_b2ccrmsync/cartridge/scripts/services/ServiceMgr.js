...
module.exports = {
    ...
    getAuthService: function () {
        return getService(require('*/cartridge/scripts/b2ccrmsync.config').services.auth, {
            ...
            parseResponse: function (svc, client) {
                var responseObj = require('*/cartridge/scripts/util/helpers').expandJSON(client.text, client.text);
            ...
            mockFull: function () {
                return require('*/cartridge/scripts/mocks/auth');
            },
    ...
    callRestService: function callRestService(model, state, requestBody, bypassCache, callCounter) {
        ...
        var svc = getService(
            ...
            require('*/cartridge/scripts/services/rest').getServiceCallback(model, state, bypassCache)
        );
